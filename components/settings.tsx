  ...
  return (
    <div className="mx-auto max-w-2xl items-center justify-center px-4 py-12">
      ...
      <p className="mb-1 text-sm font-normal">
        We are using gpt-4-1106-preview model. In order to use GPT-4, you need
        to deposit some credit. For detailed information, please visit
        <b>
          <a
        ...
        <br />
        <br />
        We will store your API KEY on only Local Storage. When you want to
        delete it from Local Storage please click Delete Button below. If you
        are using a shared computer, please ensure to delete your API key after
        use.
      </p>
